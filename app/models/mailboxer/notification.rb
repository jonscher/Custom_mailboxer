class Mailboxer::Notification < ActiveRecord::Base
  ...
  attr_accessible :body, :subject, :listing_id, :global, :expires if Mailboxer.protected_attributes?
  ...
  class << self
    ...
    def notify_all(recipients, subject, body, listing_id, obj = nil, sanitize_text = true, notification_code=nil, send_mail=true, sender=nil)
  ...
  def clean
    ...
    self.listing_id = sanitize(listing_id)
