module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, listing_id, sanitize_text=true, attachment=nil, message_timestamp = Time.now)
      ...
      def reply(conversation, recipients, reply_body, subject=nil,listing_id=nil, sanitize_text=true, attachment=nil)
        subject = subject || "#{conversation.subject}"
        listing_id = listing_id || "#{conversation.listing_id}"
      ...
      def reply_to_sender(receipt, reply_body, subject=nil,listing_id=nil, sanitize_text=true, attachment=nil)
        reply(receipt.conversation, receipt.message.sender, reply_body, subject,listing_id, sanitize_text, attachment)
      end

      #Replies to all the recipients of the message in the conversation
      def reply_to_all(receipt, reply_body, subject=nil,listing_id=nil, sanitize_text=true, attachment=nil)
        reply(receipt.conversation, receipt.message.recipients, reply_body, subject,listing_id, sanitize_text, attachment)
      end
      ...
      def reply_to_conversation(conversation, reply_body, listing_id=nil, subject=nil, should_untrash=true, sanitize_text=true, attachment=nil)
        ...
        reply(conversation, conversation.last_message.recipients, reply_body, subject, listing_id, sanitize_text, attachment)
      end
